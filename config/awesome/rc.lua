...
--local vpn_timer = timer({ timeout = 1200 })
--vpn_timer:connect_signal("timeout", function()
--	local f = io.popen("sh -c \"find /home/alex/Pictures/Wallpapers -name '*.jpg' | shuf -n 1 | xargs echo -n\"")
--	local wallpaper = f:read("*all")
--	f:close()
	for s = 1, screen.count() do
  		--gears.wallpaper.maximized("/home/alex/Pictures/Wallpapers/bkY0l.jpg", s, true)
  		gears.wallpaper.maximized("/home/alex/Pictures/Wallpapers/surreal.jpg", s, true)
	end
--end)
--vpn_timer:start()
