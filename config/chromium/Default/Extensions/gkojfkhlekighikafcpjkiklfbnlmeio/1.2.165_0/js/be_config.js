...
E.init = function(ver){
	...
	paths: {
		...
		'https://cdnjs.cloudflare.com/ajax/libs/jquery/1.8.2/'+
		'jquery.min',
	    spin: is_local ? 'spin.min' :
		'https://cdnjs.cloudflare.com/ajax/libs/spin.js/1.2.7/'+
		'spin.min',
	    purl: is_local ? 'purl' : 'https://cdnjs.cloudflare.com/ajax/libs'
	    +'/jquery-url-parser/2.2.1/purl',
	    underscore: is_local ? 'underscore.min' :
		'https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.4.4/'+
		'underscore-min',
	    backbone: is_local ? 'backbone.min' :
		'https://cdnjs.cloudflare.com/ajax/libs/backbone.js/1.0.0/'+
		'backbone-min',
