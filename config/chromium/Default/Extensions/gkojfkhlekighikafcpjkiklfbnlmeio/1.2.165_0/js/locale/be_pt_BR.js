...
var E = {
    ...
    "BN": {message: "Brunei"},
    "ZM": {message: "Zâmbia"},
    "app_desc": {message: "Acesse tudo na internet! Ir para o site bloqueado > clique no ícone Hola > mudança de bandeira do país > APROVEITE!"},
    ...
    "Access any site from any country, free": {message: "Acessar qualquer site a partir de qualquer país!"},
    ...
    "(some Hola features are not available on your version)": {message: "(Hola - alguns recursos não estão disponíveis em sua versão)"},
    "GM": {message: "Gâmbia"},
    "LV": {message: "Letônia"},
    "RU": {message: "Rússia"},
    "FI": {message: "Finlândia"},
    "Get Hola Plus for un-interrupted, ad-free service.": {message: "Obter Hola Plus sem interrupções, o serviço livre de comerciais"},
    ...
    "KH": {message: "Camboja"},
    "TG": {message: "Togo"},
    "Hola cannot work properly because another extension is controlling your proxy settings. Please disable other extensions that you think might control your proxy settings in <a>extensions</a> (such as ad-blockers, other VPN services, etc.).": {message: "s configurações de proxy da rede estão sendo gerenciadas por uma outra extensão. Desative esta extensão para continuar usando o Hola. <a>extensions</a>"},
    "BB": {message: "Barbados"},
    "JE": {message: "Jersey"},
    ...
    "GD": {message: "Granada"},
    "Number of users that use this option": {message: "Número de usuários que usam esta regra"},
    ...
    "Initializing...": {message: "Inicializando,  aguarde..."},
    ...
    "The free version of Hola needs to be re-enabled every 4 hours and is sponsored by ads.": {message: "A versão grátis do Hola precisa ser reativada a cada 4 horas e é patrocinado por anúncios"},
    "NP": {message: "Nepal"},
    "PL": {message: "Polônia"},
    "GA": {message: "Gabão"},
    ...
    "Very old version of Chrome, <a>update</a> Chrome to use Hola": {message: "Versão muito antiga do Chrome. Chrome para usar oHola <a>Atualizar</a>"},
    ...
    "Number of users that pressed not working": {message: "Número de usuários que clicaram \"não está funcionando\""},
