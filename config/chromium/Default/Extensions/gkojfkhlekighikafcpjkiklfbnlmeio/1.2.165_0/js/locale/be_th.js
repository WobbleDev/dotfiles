...
var E = {
    ...
    "CM": {message: "แคเมอรูน"},
    "The free version of Hola needs to be re-enabled every 4 hours and is sponsored by ads.": {message: "รุ่นฟรีของ Hola จะต้องเปิดการใช้งานทุก 4 ชั่วโมงและได้รับการสนับสนุนโดยโฆษณา"},
    "Hola": {message: "Hola"},
    "NP": {message: "เนปาล"},
    "PL": {message: "โปแลนด์"},
    "GA": {message: "กาบอง"},
    ...
    "Verify you have Internet": {message: "ตรวจสอบคุณมี Internet"},
    "LA": {message: "ลาว"},
    ...
    "IN": {message: "อินเดีย"},
    "Unblocker site list": {message: "รายการเว็บไซต์ Unblocker"},
