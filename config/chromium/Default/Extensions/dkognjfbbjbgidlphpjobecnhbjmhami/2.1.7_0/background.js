...
chrome.runtime.onInstalled
		.addListener(function(details) {
			...
			if (details.reason == "update") {
				...
				if (compareVersions(details.previousVersion, "2.1.7") == -1) {
					major = true;
				}
				if (major) {
					alert("Due to legal issues, Bingo will be retired from Jan.1, 2014. If you are a current user, please remove it by then. Visit http://gtiny.me/956 for details.");
				}
			}
		});
